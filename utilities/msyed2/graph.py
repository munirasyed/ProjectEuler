...
class Graph(object):
    ...
    def bfs(self, start_node_num):
        ...
        q=[]
        q.append(node.value)
        #print(q, node.visited)
        while q!=[]:
            node=self.find_node(q.pop(0))
            for i in node.edges:
                
                if i.node_to.visited==False:
                    #print(i.node_to.value, ret_list)
                    ret_list.append(i.node_to.value)
                    i.node_to.visited=True
                    q.append(i.node_to.value)
